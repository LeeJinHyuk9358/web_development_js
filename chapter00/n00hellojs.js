...
// b = true;        // 2인 변수 b에 boolean 자료형 대입
...
// let c = 12;
// n00hellojs.js:36 Uncaught SyntaxError: Identifier 'c' has already been declared (at n00hellojs.js:36:5) -> 라고 오류 발생
...
// let z = 1;
// console.log(typeof z) // numbers

// const bool03 = 1 < 2;
// const bool04 = 1 > 2;
// console.log(bool03, bool04) // true false
// 이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되구요, 비교 연산의 결과값을 산출할 때 많이 사용됩니다.
...
// console.log(person01); // 객체에 빈값들을 재대입 -> 오류 발생
